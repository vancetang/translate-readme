  ...
  /******/ [
      ...
      function deleteBranchesTask(branches, forceDelete = false) {
        return {
          ...
          onError(exitCode, error, done, fail) {
            if (
              !parse_branch_delete_1.hasBranchDeletionError(error, exitCode)
            ) {
              return fail(error);
            }
            done(error);
      ...
      function deleteBranchTask(branch, forceDelete = false) {
        const task = {
          ...
          onError(exitCode, error, _, fail) {
            ...
            throw new git_response_error_1.GitResponseError(
              task.parser(error, ""),
              error
            );
          },
    ...
    /***/ function (module) {
      ...
      DiffSummary.parse = function (text) {
          ...
          summary
            ...
            .forEach(function (text) {
              ...
              if (/files?/.test(summary[2])) {
                ...
                status[summary[2].replace(/s$/, "") + "s"] = parseInt(
                  summary[1],
                  10
                );
              }
        ...
        while ((line = lines.shift())) {
          textFileChange(line, status.files) ||
            binaryFileChange(line, status.files);
        }
          ...
          const makeRequest = () => {
            ...
            const reject = (error) => {
              void (async () => {
                try {
                  ...
                  _reject(
                    new types_1.RequestError(error_.message, error_, request)
                  );
                  return;
                }
                _reject(error);
            ...
            const onError = async (error) => {
              ...
              try {
                ...
                request.destroy();
                reject(
                  new types_1.RequestError(error_.message, error, request)
                );
                return;
              }
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const parsers = [
        new utils_1.LineParser(deleteSuccessRegex, (result, [branch, hash]) => {
          const deletion = BranchDeleteSummary_1.branchDeletionSuccess(
            branch,
            hash
          );
      ...
      exports.parseBranchDeletions = (stdOut) => {
        return utils_1.parseStringResponse(
          new BranchDeleteSummary_1.BranchDeletionBatch(),
          parsers,
          stdOut
        );
      };
      function hasBranchDeletionError(data, processExitCode) {
        return (
          processExitCode === utils_1.ExitCodes.ERROR &&
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const isErrorWithResponse = (error) =>
        ...
        error instanceof types_1.ParseError ||
        error instanceof types_1.MaxRedirectsError;
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      class Request extends stream_1.Duplex {
        ...
        static normalizeArguments(url, options, defaults) {
          ...
          options.maxRedirects =
            (_d = options.maxRedirects) !== null && _d !== void 0 ? _d : 0;
 ...
 */
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const utils_1 = __webpack_require__(847);
      debug_1.default.formatters.L = (value) =>
        String(utils_1.filterHasLength(value) ? value.length : "-");
      ...
      function createLogger(
        ...
        const key = childLoggerName(
          utils_1.filterType(verbose, utils_1.filterString),
          debugDebugger,
          infoDebugger
        );
        const kill = (
          (debugDebugger === null || debugDebugger === void 0
            ? void 0
            : debugDebugger.destroy) || utils_1.NOOP
        ).bind(debugDebugger);
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const onError = (exitCode, stdErr, done, fail) => {
        if (
          exitCode === utils_1.ExitCodes.UNCLEAN &&
          isNotRepoMessage(stdErr)
        ) {
          return done("false");
        }
        fail(stdErr);
      ...
      function visitParents(tree, test, visitor, reverse) {
        ...
        function one(child, index, parents) {
          ...
          function node() {
            ...
            if (
              !test ||
              is(child, index, parents[parents.length - 1] || null)
            ) {
            ...
            subresult = toResult(
              children(child.children, parents.concat(child))
            );
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      exports.parseBranchSummary = function (stdOut) {
        return utils_1.parseStringResponse(
          new BranchSummary_1.BranchSummaryResult(),
          parsers,
          stdOut
        );
      };
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const { normalizeArguments, mergeOptions } =
        as_promise_1.PromisableRequest;
      const getPromiseOrStream = (options) =>
        options.isStream
          ? new core_1.default(options.url, options)
      ...
      const create = (defaults) => {
        ...
        const got = (url, options, _defaults) => {
          ...
          try {
            ...
            if (
              options === null || options === void 0 ? void 0 : options.isStream
            ) {
              throw error;
            } else {
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      function parseStringResponse(result, parsers, text) {
        for (
          let lines = util_1.toLinesWithContent(text),
            i = 0,
            max = lines.length;
          i < max;
          i++
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const CleanOptionValues = new Set([
        "i",
        ...utils_1.asStringArray(Object.values(CleanOptions)),
      ]);
      function cleanWithOptionsTask(mode, customArgs) {
        const { cleanMode, options, valid } = getCleanOptions(mode);
        if (!cleanMode) {
          return task_1.configurationErrorTask(
            exports.CONFIG_ERROR_MODE_REQUIRED
          );
        }
        if (!valid.options) {
      ...
      function cleanTask(mode, customArgs) {
        ...
        return {
          ...
          format: "utf-8",
          parser(text) {
            return CleanSummary_1.cleanSummaryParser(
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      class Scheduler {
        ...
        next() {
          const { promise, id } = utils_1.append(
            this.pending,
            createScheduledTask()
          );
    ...
    /***/ function (module, __unusedexports, __webpack_require__) {
      ...
      const { esModuleFactory, gitInstanceFactory, gitExportFactory } =
    ...
    /***/ function (module, __unusedexports, __webpack_require__) {
      ...
      var otherElementOpenExpression = new RegExp(
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      exports.parsePushResult = (stdOut, stdErr) => {
        ...
        const responseDetail = parse_remote_messages_1.parseRemoteMessages(
          stdOut,
          stdErr
        );
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      class GitExecutorChain {
        ...
        onFatalException(task, e) {
          const gitError =
            e instanceof api_1.GitError
              ? Object.assign(e, { task })
              : new api_1.GitError(task, e && String(e));
          this._chain = Promise.resolve();
              ...
              return onError(
                ...
                (result) => {
                  ...
                  logger(
                    ...
                    utils_1.objectToString(result)
                  );
                  done(
                    new utils_1.GitOutputStreams(
        ...
        gitResponse(command, args, outputHandler, logger) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((done) => {
              ...
              const spawned = child_process_1.spawn(
                command,
                args,
                spawnOptions
              );
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      function trailingArrayArgument(args) {
        ...
        return argument_filters_1.filterType(
          util_1.last(args, hasTrailingCallback ? 1 : 0),
          argument_filters_1.filterArray,
          []
        );
      }
      /**
      ...
      function trailingOptionsArgument(args) {
        const hasTrailingCallback = argument_filters_1.filterFunction(
          util_1.last(args)
        );
        return argument_filters_1.filterType(
          util_1.last(args, hasTrailingCallback ? 1 : 0),
          argument_filters_1.filterPlainObject
        );
      }
      ...
      function trailingFunctionArgument(args, includeNoop = true) {
        ...
        return includeNoop || util_1.isUserFunction(callback)
          ? callback
          : undefined;
      }
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      Object.defineProperty(exports, "CancelError", {
        enumerable: true,
        get: function () {
          return p_cancelable_1.CancelError;
        },
      });
      const core_1 = __webpack_require__(94);
    ...
    /***/ function (module, __unusedexports, __webpack_require__) {
      ...
      const { adhocExecTask, configurationErrorTask } =
      ...
      const { cleanWithOptionsTask, isCleanOptionsArray } =
      ...
      const { addAnnotatedTagTask, addTagTask, tagListTask } =
      ...
      Git.prototype.stashList = function (options, then) {
        ...
        var splitter =
          opt.splitter || requireResponseHandler("ListLogSummary").SPLITTER;
        var command = [
          "stash",
          "list",
          "--pretty=format:" +
        ...
        return this._run(command, handler, {
          parser: Git.responseParser("ListLogSummary", splitter),
        });
      };
      ...
      Git.prototype.commit = function (message, files, options, then) {
        ...
        asArray(
          typeof files === "string" || Array.isArray(files) ? files : []
        ).forEach((cmd) => command.push(cmd));
       ...
       */
      Git.prototype.deleteLocalBranch = function (
        branchName,
        forceDelete,
        then
      ) {
       ...
       */
      Git.prototype.deleteLocalBranches = function (
        branchNames,
        forceDelete,
        then
      ) {
      ...
      Git.prototype.addConfig = function (key, value, append, then) {
        return this._runTask(
          addConfigTask(
            key,
            value,
            typeof append === "boolean" ? append : false
          ),
          trailingFunctionArgument(arguments)
        );
      };
      ...
      Git.responseParser = function (type, args) {
        ...
        return function (data) {
          return handler.parse.apply(
            handler,
            [data].concat(args === undefined ? [] : args)
          );
        };
      };
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      const parsers = [
        ...
        new utils_1.LineParser(
          ...
          (summary, [reason, file]) => {
            summary.conflicts.push(
              new MergeSummary_1.MergeSummaryConflict(reason, file)
            );
          }
        ),
        new utils_1.LineParser(
        ...
        new utils_1.LineParser(/^CONFLICT\s+\((.+)\):/, (summary, [reason]) => {
          summary.conflicts.push(
            new MergeSummary_1.MergeSummaryConflict(reason, null)
          );
        }),
        new utils_1.LineParser(
      ...
      exports.parseMergeDetail = (stdOut) => {
        return utils_1.parseStringResponse(
          new MergeSummary_1.MergeSummaryDetail(),
          parsers,
          stdOut
        );
      };
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      class GitExecutor {
        constructor(binary = "git", cwd, _scheduler) {
          ...
          this.cwd = cwd;
          this._scheduler = _scheduler;
          this._chain = new git_executor_chain_1.GitExecutorChain(
            this,
            this._scheduler
          );
        }
        chain() {
          return new git_executor_chain_1.GitExecutorChain(
            this,
            this._scheduler
          );
        }
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      exports.TaskConfigurationError =
        task_configuration_error_1.TaskConfigurationError;
      ...
      class FileStatusSummary {
        constructor(path, index, working_dir) {
          ...
          if ("R" === index + working_dir) {
            const detail = exports.fromPathRegex.exec(path) || [
              null,
              path,
              path,
            ];
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      function initTask(bare = false, path, customArgs) {
        ...
        return {
          ...
          format: "utf-8",
          parser(text) {
            return InitSummary_1.parseInit(
              commands.includes("--bare"),
              path,
              text
            );
          },
        ...
        return {
          ...
          parser() {
            throw typeof error === "string"
              ? new task_configuration_error_1.TaskConfigurationError(error)
              : error;
          },
        };
      }
 ...
 */
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      function addDeprecationNoticeToError(err) {
        let log = (name) => {
          console.warn(
            `simple-git deprecation notice: accessing GitResponseError.${name} should be GitResponseError.git.${name}`
          );
          log = utils_1.NOOP;
        };
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      function addRemoteTask(remoteName, remoteRepo, customArgs = []) {
        return task_1.straightThroughStringTask([
          "remote",
          "add",
          ...customArgs,
          remoteName,
      ...
      function getRemotesTask(verbose) {
        ...
        return {
          ...
          format: "utf-8",
          parser: verbose
            ? GetRemoteSummary_1.parseGetRemotesVerbose
            : GetRemoteSummary_1.parseGetRemotes,
        };
      }
    ...
    /***/ function (module) {
      ...
      CommitSummary.parse = function (commit) {
        ...
        setBranchFromCommit(
          commitSummary,
          COMMIT_BRANCH_MESSAGE_REGEX.exec(lines.shift())
        );

        if (COMMIT_AUTHOR_MESSAGE_REGEX.test(lines[0])) {
          setAuthorFromCommit(
            commitSummary,
            COMMIT_AUTHOR_MESSAGE_REGEX.exec(lines.shift())
          );
        }

        setSummaryFromCommit(
          commitSummary,
          /(\d+)[^,]*(?:,\s*(\d+)[^,]*)?(?:,\s*(\d+))?/g.exec(lines.shift())
        );
    ...
    /***/ function (module, __unusedexports, __webpack_require__) {
      ...
      for (
        let imported = __webpack_require__(732),
      ...
      module.exports.gitExportFactory = function gitExportFactory(
        factory,
        extra
      ) {
        return Object.assign(
    ...
    /***/ function (__unusedmodule, exports, __webpack_require__) {
      ...
      function forEach(text, handler) {
        utils_1.forEachLineWithContent(text, (line) =>
          handler(line.split(/\s+/))
        );
      }
